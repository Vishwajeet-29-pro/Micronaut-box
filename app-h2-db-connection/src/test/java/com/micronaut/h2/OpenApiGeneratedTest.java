...
class OpenApiGeneratedTest {
    ...
    void buildGeneratesOpenApi(ResourceLoader resourceLoader) {
        assertTrue(resourceLoader.getResource("META-INF/swagger/micronaut-h2-database-connection-1.0.yml").isPresent());
    ...
    void openApi(@Client("/") HttpClient httpClient) {
        ...
        assertDoesNotThrow(() -> client.exchange("/swagger/micronaut-h2-database-connection-1.0.yml"));
